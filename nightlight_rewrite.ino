...
long touchThreshold = 300; // What the touch sensor must pass to register a touch.
...
int animeSpeed; // Speed at which the LEDs change frames.
...
int ledsMax[] = {1000, 1000, 1000, 1000, 0, 0}; // What each LED will fade up to.
int ledsMin[] = {5, 5, 5, 5, 0, 0}; // What each LED will fade down to.
int ledsAttack[] = {20, 20, 20, 20, 0, 0}; // Each LED can have its own increase speed
int ledsDecay[] = {20, 20, 20, 20, 0, 0}; // and decrease
